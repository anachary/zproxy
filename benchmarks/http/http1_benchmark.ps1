...
$resultsFile = "$resultsDir/http1_$timestamp.txt"
...
try {
    ...
    # Run the benchmark
    zig build benchmark -- "http://localhost:8000/" $Connections $Duration $Concurrency $keepAliveInt "http1" $resultsFile 0
